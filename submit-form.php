...
try {
    ...
    $sheetsData = json_encode([
        ...
        'preferreddestination' => $data['preferred_study_destination'],
        'educationlevel' => $data['current_level_of_education'],
        'languagetest' => $data['language_test_taken'],
    ...
    $sheetsResponse = file_get_contents(
        'https://script.google.com/macros/s/AKfycbxlbOEBFOEuJRWITOOVvci1gXU8wbn46Fq1TCX_sB4Pqs4dt229U2CIGKagRvIdBZCG/exec',
        false,
